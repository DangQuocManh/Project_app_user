...
class SearchAdvancedUserActivity : AppCompatActivity(), SearchAdvencedAdapter.ISearchData {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_search_advanced_user)
        init()
        getData()
    ...
    private fun init() {
        imgBackSearch = findViewById(R.id.imb_back_search_again_user)
        rcProduct = findViewById(R.id.rc_search_advanced_user)
    ...
    override fun onClickItemSearch(position: Int) {
        val intent = Intent()
        intent.setClass(this, DetailProductUserActivity::class.java)
        val bundle = Bundle()
