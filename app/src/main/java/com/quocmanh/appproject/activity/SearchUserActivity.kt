...
class SearchUserActivity : AppCompatActivity(), SearchAdapter.ISearchData {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        courseRV = findViewById(R.id.idRVCoursesUser)
        ...
        callApi.getAllProduct1()
            ...
            .subscribe({
                ...
                if(message == "success"){
                    ...
                    courseRVAdapter = SearchAdapter(this, productList)
                    courseRV.layoutManager = GridLayoutManager(this, 2, LinearLayoutManager.VERTICAL, false)
                    courseRV.adapter = courseRVAdapter
                    courseRVAdapter.notifyDataSetChanged()
                }
            },{
