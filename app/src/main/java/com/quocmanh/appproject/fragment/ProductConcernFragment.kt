...
class ProductConcernFragment : Fragment(), ConcernProductAdapter.IConcernProduct {
    ...
    override fun onCreateView(
        ...
        mView = inflater.inflate(R.layout.fragment_product_concern, container, false)
        init(mView)
        getProductConcern()
        return mView
    }
    ...
    private fun init(view : View){
        rcConcern = view.findViewById(R.id.rc_product_concern)
